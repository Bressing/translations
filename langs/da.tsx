...
const messages:IMessages = {
  ...
  "(Drop files or click)": {
    val: "(Drop filer eller tryk)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Hvis du vil have svar)",
    translated: true,
  ...
  "A sync is already in progress": {
    val: "Synkronisering er allerede igang",
    translated: true,
  ...
  "Any other monthly bills you have?": {
    val: "Har du andre månedlige regninger?",
    translated: true,
    h: "rmA9D10bvYOVj3U4kE7U6jALpz7WpqBJTv6HZaI4T/M=",
  },
  "Application preferences": {
    val: "Program indstillinger",
    translated: true,
  ...
  "Attached files are too large.": {
    val: "Vedhæftede filer er for store.",
    translated: true,
